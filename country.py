...
countries = [
    ...
    Country("Austria", "America Movil", "Deutsche Telekom", "CK Huchinson"),
    ...
    Country("Croatia", "America Movil", "Deutsche Telekom"),
    ...
    Country("North Macedonia", "America Movil", "Deutsche Telekom"),
    Country("Panama", "America Movil"),
    Country("Paraguay", "America Movil"),
    Country("Peru", "America Movil", "Telefonica", "Viettel"),
    Country("Puerto Rico", "America Movil", "Deutsche Telekom", "Verizon"),
    ...
    Country("Germany", "Vodafone Group", "Telefonica", "Deutsche Telekom"),
